                                ...
                                <div class="col-xl-4 d-flex align-items-center justify-content-center">
                                    <div class="tab-left">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                    ...
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_1.png" alt="thumb">
                                                            </div>
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-chickenFriedRice-tab" data-bs-toggle="pill"
                                                    data-bs-target="#pills-chickenFriedRice" role="tab"
                                                    aria-controls="pills-chickenFriedRice" aria-selected="false">
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_2.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-chickenPizza-tab" data-bs-toggle="pill"
                                                    ...
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_3.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                                                <h3> Chicken Pizza </h3>
                                                                <p>It's a testament to our.</p>
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-chickenNoodles-tab" data-bs-toggle="pill"
                                                    data-bs-target="#pills-chickenNoodles" role="tab"
                                                    aria-controls="pills-chickenNoodles" aria-selected="false">
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_4.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-grilledChicken-tab" data-bs-toggle="pill"
                                                    data-bs-target="#pills-grilledChicken" role="tab"
                                                    aria-controls="pills-grilledChicken" aria-selected="false">
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_5.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-EggCucumber-tab" data-bs-toggle="pill"
                                                    ...
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_6.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-chickenWhiteRice-tab"
                                                    ...
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_7.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-specialBurger-tab" data-bs-toggle="pill"
                                                    ...
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_8.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-vegetablesBurger-tab"
                                                    ...
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_9.png" alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link" id="pills-briefChicken-tab" data-bs-toggle="pill"
                                                    ...
                                                    <div class="single-menu-items">
                                                        <div class="details">
                                                            <div class="menu-item-thumb"><img
                                                                    src="assets/img/menu/menuThumb2_10.png"
                                                                    alt="thumb">
                                                            </div>
                                                            <div class="menu-content">
                                                                <h3> Brief Chicken </h3>
