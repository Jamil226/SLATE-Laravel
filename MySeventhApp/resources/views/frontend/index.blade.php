...
@section('main-container')
    ...
    <section class="banner-section fix">
        <div class="slider-area">
            <div class="swiper banner-slider">
                    ...
                    <div class="swiper-slide">
                        <div class="banner-wrapper style1 bg-img">
                            <div class="shape1_1 d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".3s"><img src="frontend/img/shape/bannerShape1_1.svg" alt="shape"></div>
                            <div class="shape1_2 d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".3s"><img src="frontend/img/shape/bannerShape1_2.svg" alt="shape"></div>
                            <div class="shape1_3 d-none d-xxl-block" data-animation="slideInLeft" data-duration="3s"
                                data-delay="2s"><img src="frontend/img/shape/bannerShape1_3.svg" alt="shape"></div>
                            <div class="shape1_4 d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".3s"><img src="frontend/img/shape/bannerShape1_4.svg" alt="shape"></div>
                            <div class="shape1_5 d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".3s"><img src="frontend/img/shape/bannerShape1_5.svg" alt="shape"></div>
                            <div class="shape1_6 d-none d-xxl-block cir36"><img src="frontend/img/shape/bannerShape1_6.svg"
                                    alt="shape"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 d-none d-xxl-block">
                                            <div class="banner-thumb-area" data-tilt data-animation="slideInRight"
                                                ...
                                                <img src="frontend/img/banner/bannerThumb1_1.png" alt="shape">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="banner-wrapper style1 bg-img">
                            ...
                            <div class="shape1_4 d-none d-xxl-block float-bob-x" data-animation="slideInLeft"
                                data-duration="2s" data-delay=".3s"><img src="frontend/img/shape/bannerShape1_4.svg"
                                    alt="shape"></div>
                            <div class="shape1_5 d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".3s"><img src="frontend/img/shape/bannerShape1_5.svg" alt="shape"></div>
                            <div class="shape1_6 d-none d-xxl-block cir36"><img
                                    src="frontend/img/shape/bannerShape1_6.svg" alt="shape"></div>
                            <div class="overlay"></div>
                            <div class="banner-container">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 d-none d-xxl-block">
                                            <div class="banner-thumb-area" data-tilt data-animation="slideInRight"
                                                data-duration="2s" data-delay=".9s">
                                                <img src="frontend/img/banner/bannerThumb1_2.png" alt="shape">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 d-none d-xxl-block">
                                            <div class="banner-thumb-area" data-tilt data-animation="slideInRight"
                                                data-duration="2s" data-delay=".9s">
                                                <img src="frontend/img/banner/bannerThumb1_3.png" alt="shape">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="arrow-prev"><img src="frontend/img/icon/arrowPrev.svg" alt="Icon"></div>
                <div class="arrow-next"><img src="frontend/img/icon/arrowNext.svg" alt="Icon"></div>
    ...
    <section class="best-food-items-section fix section-padding bg-color2">
        <div class="best-food-wrapper">
            <div class="shape1 float-bob-y d-none d-xxl-block"><img src="frontend/img/shape/bestFoodItemsShape1_1.png"
                    alt="shape"></div>
            <div class="shape2 float-bob-x d-none d-xxl-block"><img src="frontend/img/shape/bestFoodItemsShape1_2.png"
                    alt="shape"></div>
            <div class="container">
                <div class="title-area">
                    <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                        <img class="me-1" src="frontend/img/icon/titleIcon.svg" alt="icon">Best Food <img
                            src="frontend/img/icon/titleIcon.svg" alt="icon">
                    </div>
                    ...
                    <div class="swiper bestFoodItems-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="single-food-items">
                                    <div class="item-thumb">
                                        <img src="frontend/img/food-items/item1_1.png" alt="thumb">
                                        <div class="circle-shape"><img class="cir36"
                                                src="frontend/img/food-items/circleShape.png" alt="shape"></div>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="single-food-items">
                                    <div class="item-thumb">
                                        <img src="frontend/img/food-items/item1_2.png" alt="thumb">
                                        <div class="circle-shape"><img class="cir36"
                                                src="frontend/img/food-items/circleShape.png" alt="shape"></div>
                                    </div>
                                    <div class="item-content">
                            ...
                            <div class="swiper-slide">
                                <div class="single-food-items">
                                    <div class="item-thumb">
                                        <img src="frontend/img/food-items/item1_3.png" alt="thumb">
                                        <div class="circle-shape"><img class="cir36"
                                                src="frontend/img/food-items/circleShape.png" alt="shape"></div>
                                    </div>
                                    <div class="item-content">
                            ...
                            <div class="swiper-slide">
                                <div class="single-food-items">
                                    <div class="item-thumb">
                                        <img src="frontend/img/food-items/item1_4.png" alt="thumb">
                                        <div class="circle-shape"><img class="cir36"
                                                src="frontend/img/food-items/circleShape.png" alt="shape"></div>
                                    </div>
                                    <div class="item-content">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6 col-xl-4">
                        <div class="offer-card style1 wow fadeInUp" data-wow-delay="0.2s"
                            style="background-image: url(frontend/img/bg/offerBG1_1.jpg);">
                            ...
                            <div class="offer-thumb">
                                <img class="thumbImg" src="frontend/img/offer/offerThumb1_1.png" alt="thumb">
                                <div class="shape float-bob-x"><img src="frontend/img/shape/offerShape1_4.png"
                                        alt="shape"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-4">
                        <div class="offer-card style1 wow fadeInUp" data-wow-delay="0.5s"
                            ...
                            <div class="offer-thumb">
                                <img class="thumbImg" src="frontend/img/offer/offerThumb1_2.png" alt="thumb">
                                <div class="shape float-bob-x"><img src="frontend/img/shape/offerShape1_4.png"
                                        alt="shape"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="offer-card style1  wow fadeInUp" data-wow-delay="0.7s"
                            ...
                            <div class="offer-thumb">
                                <img class="thumbImg" src="frontend/img/offer/offerThumb1_3.png" alt="thumb">
                                <div class="shape float-bob-x"><img src="frontend/img/shape/offerShape1_4.png"
                                        alt="shape"></div>
                            </div>
                        </div>
    ...
    <section class="about-us-section fix section-padding pb-0">
        <div class="about-wrapper style1">
            <div class="shape1 d-none d-xxl-block"><img src="frontend/img/shape/aboutShape1_1.png" alt="shape"></div>
            <div class="shape2 d-none d-xxl-block"><img src="frontend/img/shape/aboutShape1_2.png" alt="shape"></div>
            <div class="shape3 d-none d-xxl-block"><img class="cir36" src="frontend/img/shape/aboutShape1_3.png"
                    alt="shape"></div>
            <div class="shape4 d-none d-xxl-block"><img src="frontend/img/shape/aboutShape1_4.png" alt="shape"></div>
            <div class="shape5 d-none d-xxl-block"><img src="frontend/img/shape/aboutShape1_5.png" alt="shape"></div>
            <div class="shape6 d-none d-xxl-block"><img class="cir36" src="frontend/img/shape/aboutShape1_6.png"
                    alt="shape"></div>
            <div class="container">
                <div class="about-us section-padding">
                    <div class="row">
                        <div class="col-12">
                            <div class="title-area">
                                <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                                    <img class="me-1" src="frontend/img/icon/titleIcon.svg" alt="icon">About US<img
                                        class="ms-1" src="frontend/img/icon/titleIcon.svg" alt="icon">
                                </div>
                                <h2 class="title wow fadeInUp" data-wow-delay="0.7s">
    ...
    <section class="popular-dishes-section fix section-padding">
        <div class="popular-dishes-wrapper style1">
            <div class="shape1 d-none d-xxl-block"><img src="frontend/img/shape/popularDishesShape1_1.png"
                    alt="shape">
            </div>
            <div class="shape2 float-bob-y d-none d-xxl-block"><img src="frontend/img/shape/popularDishesShape1_2.png"
                    alt="shape"></div>
            <div class="container">
                <div class="title-area">
                    <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                        <img class="me-1" src="frontend/img/icon/titleIcon.svg" alt="icon">POPULAR DISHES<img
                            class="ms-1" src="frontend/img/icon/titleIcon.svg" alt="icon">
                    </div>
                    <h2 class="title wow fadeInUp" data-wow-delay="0.7s">
                        Best selling Dishes
                ...
                <div class="dishes-card-wrap style1">
                    <div class="dishes-card style1 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="dishes-thumb">
                            <img src="frontend/img/dishes/dishes1_1.png" alt="thmb">
                        </div>
                        <a href="menu.html">
                            <h3>Chicken Fried Rice</h3>
                        </a>
                    ...
                    <div class="dishes-card style1 wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="dishes-thumb">
                            <img src="frontend/img/dishes/dishes1_2.png" alt="thmb">
                        </div>
                        <a href="menu.html">
                            <h3>Chinese Pasta</h3>
                        </a>
                    ...
                    <div class="dishes-card style1 wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="dishes-thumb">
                            <img src="frontend/img/dishes/dishes1_3.png" alt="thmb">
                        </div>
                        <a href="menu.html">
                            <h3>Chicken Pizza</h3>
                        </a>
                    ...
                    <div class="dishes-card style1 wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="dishes-thumb">
                            <img src="frontend/img/dishes/dishes1_4.png" alt="thmb">
                        </div>
                        <a href="menu.html">
                    ...
                    <div class="dishes-card style1 wow fadeInUp" data-wow-delay="0.9s">
                        ...
                        <div class="dishes-thumb">
                            <img src="frontend/img/dishes/dishes1_5.png" alt="thmb">
                        </div>
                        <a href="menu.html">
                                ...
                                <div class="col-xxl-6">
                                    <div class="modal-thumb">
                                        <div class="product-big-img bg-color2">
                                            <div class="dishes-thumb">
                                                <img class="img-fluid" src="frontend/img/dishes/dishes3_1.png"
                                                    alt="thumb">
                                                <div class="circle-shape"><img class="cir36"
                                                        src="frontend/img/food-items/circleShape2.png" alt="shape">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section class="cta-section fix">
        <div class="cta-wrapper style1  section-padding">
            <div class="shape1 float-bob-x d-none d-xxl-block"><img src="frontend/img/shape/ctaShape1_1.png"
                    alt="shape">
            </div>
            <div class="shape2 float-bob-y d-none d-xxl-block"><img src="frontend/img/shape/ctaShape1_2.png"
                    alt="shape">
            </div>
            <div class="shape3 float-bob-y d-none d-xxl-block"><img src="frontend/img/shape/ctaShape1_3.png"
                    alt="shape">
            </div>
            <div class="container">
                <div class="cta-wrap style1">
                    <div class="row">
                        ...
                        <div class="col-xl-6 order-1 order-xl-2">
                            <div class="cta-thumb">
                                <img class="img-fluid float-bob-x" src="frontend/img/cta/ctaThumb1_1.png" alt="thumb">
                            </div>
                        </div>
                    </div>
    ...
    <section class="food-menu-section fix section-padding">
        <div class="burger-shape">
            <img src="frontend/img/shape/burger-shape.png" alt="img">
        </div>
        <div class="fry-shape">
            <img src="frontend/img/shape/fry-shape.png" alt="img">
        </div>
        <div class="food-menu-wrapper style1">
            <div class="container">
                <div class="food-menu-tab-wrapper style-bg">
                    <div class="title-area">
                        <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                            <img class="me-1" src="frontend/img/icon/titleIcon.svg" alt="icon">FOOD MENU<img
                                class="ms-1" src="frontend/img/icon/titleIcon.svg" alt="icon">
                        </div>
                        <h2 class="title wow fadeInUp" data-wow-delay="0.7s">
                            Fresheat Foods Menu
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-FastFood-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-FastFood" aria-selected="true"><img
                                        src="frontend/img/menu/menuIcon1_1.png" alt="icon">Fast Food</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-drinkJuice-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-drinkJuice" aria-selected="false"><img
                                        src="frontend/img/menu/menuIcon1_2.png" alt="icon">Drink & Juice</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-chickenPizza-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-chickenPizza" aria-selected="false"><img
                                        src="frontend/img/menu/menuIcon1_3.png" alt="icon">Chicken Pizza</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-freshPasta-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-freshPasta" aria-selected="false"><img
                                        src="frontend/img/menu/menuIcon1_4.png" alt="icon">Fresh Pasta</button>
                            </li>
                        </ul>
                                ...
                                <div class="row gx-60">
                                    <div class="col-lg-6">
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_1.png"
                                                        alt="thumb"></div>
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_2.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                                        <h3>Chicken Fried Rice</h3>
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_3.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                                        <h3>Chicken Pizza</h3>
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_4.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                                        <h3>Chicken Noodles</h3>
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_5.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                                        <h3>Grilled Chicken</h3>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_6.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                                        <h3>Egg and Cucumber</h3>
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_7.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_8.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img src="frontend/img/menu/menuThumb1_9.png"
                                                        alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-item-thumb"><img
                                                        src="frontend/img/menu/menuThumb1_10.png" alt="thumb"></div>
                                                <div class="menu-content">
                                                    <a href="menu.html">
                                                        <h3>Brief Chicken</h3>
                                                    </a>
            ...
            <div class="container">
                <div class="timer-wrap style1">
                    <div class="shape1 d-none d-xxl-block"><img class="cir36"
                            src="frontend/img/shape/timerShape1_1.svg" alt="shape"></div>
                    <div class="shape2 d-none d-xxl-block"><img src="frontend/img/shape/timerShape1_2.svg"
                            alt="shape">
                    </div>
                    <div class="shape3 d-none d-xxl-block"><img src="frontend/img/shape/timerShape1_3.svg"
                            alt="shape">
                    </div>
                    <div class="container">
                        <div class="row gy-4 gx-134">
                            <div class="col-lg-6 d-flex align-items-center">
                                <div class="timer-thumb wow fadeInUp" data-wow-delay="0.3s">
                                    <img src="frontend/img/timer/timerThumb1_1.png" alt="thumb">
                                </div>
                            </div>
                            <div class="col-lg-6 d-flex align-items-center">
                                <div class="timer-card style1 wow fadeInUp" data-wow-delay="0.5s">
                                    <div class="title-area">
                                        <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                                            <img class="me-1" src="frontend/img/icon/titleIcon.svg"
                                                alt="icon">Special
                                            Offer<img class="ms-1" src="frontend/img/icon/titleIcon.svg"
                                                alt="icon">
                                        </div>
    ...
    <section class="chefe-section fix section-padding">
        <div class="chefe-wrapper style1">
            <div class="shape1 d-none d-xxl-block"><img class="float-bob-y" src="frontend/img/shape/chefeShape1_1.png"
                    alt="shape"></div>
            <div class="shape2 d-none d-xxl-block"><img class="float-bob-x" src="frontend/img/shape/chefeShape1_2.png"
                    alt="shape"></div>
            <div class="container">
                <div class="title-area">
                    <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                        <img class="me-1" src="frontend/img/icon/titleIcon.svg" alt="icon">OUR CHEFE<img
                            class="ms-1" src="frontend/img/icon/titleIcon.svg" alt="icon">
                    </div>
                    <h2 class="title  wow fadeInUp" data-wow-delay="0.7s">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-4">
                            <div class="chefe-card style1 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="chefe-thumb">
                                    <img src="frontend/img/chefe/chefeThumb1_1.png" alt="thumb">
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="chefe-card style1 wow fadeInUp" data-wow-delay="0.4s">
                                <div class="chefe-thumb">
                                    <img src="frontend/img/chefe/chefeThumb1_2.png" alt="thumb">
                                </div>
                                <div class="icon">
                                    <a class="hovered-icon" href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#"><i class="fa-light fa-share-nodes"></i></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="chefe-card style1 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="chefe-thumb">
                                    <img src="frontend/img/chefe/chefeThumb1_3.png" alt="thumb">
                                </div>
                                <div class="icon">
                                    <a class="hovered-icon" href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#"><i class="fa-light fa-share-nodes"></i></a>
                ...
                <div class="slider-area pt-5 mt-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="swiper clientSliderOne">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="client-img text-center"><img src="frontend/img/logo/clientLogo1_1.png"
                                        alt="logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="client-img text-center"><img src="frontend/img/logo/clientLogo1_2.png"
                                        alt="logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="client-img text-center"><img src="frontend/img/logo/clientLogo1_3.png"
                                        alt="logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="client-img text-center"><img src="frontend/img/logo/clientLogo1_4.png"
                                        alt="logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="client-img text-center"><img src="frontend/img/logo/clientLogo1_5.png"
                                        alt="logo">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="client-img text-center"><img src="frontend/img/logo/clientLogo1_6.png"
                                        alt="logo">
                                </div>
                            </div>
                        </div>
    ...
    <section class="testimonial-section fix bg-color3">
        <div class="testimonial-wrapper style1 section-padding ">
            <div class="shape"><img src="frontend/img/testimonial/testimonialThumb1_1.png" alt="thumb"></div>
            <div class="shape2"><img src="frontend/img/shape/testimonialShape1_1.png" alt="shape"></div>
            <div class="container">
                    ...
                    <div class="col-xl-5 d-flex align-items-center justify-content-center">
                        <div class="video-wrap cir36 ">
                            <a href="https://www.youtube.com/watch?v=f2Gzr8sAGB8" class="play-btn popup-video"><img
                                    src="frontend/img/shape/player.svg" alt="icon"></a>
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class="title-area">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-card style1">
                                            <div class="testimonial-header">
                                                <div class="fancy-box">
                                                    <div class="item1"><img
                                                            src="frontend/img/testimonial/testimonialProfile1_1.png"
                                                            alt="thumb"></div>
                                                    <div class="item2">
                                                        <h6>Albert Flores</h6>
                                                        <p>Web Designer</p>
                                                        <div class="icon"><img src="frontend/img/icon/star.svg"
                                                                alt="icon"></div>
                                                    </div>
                                                    <div class="quote"><img src="frontend/img/icon/quote.svg"
                                                            alt="icon">
                                                    </div>
                                                </div>
                                            </div>
    ...
    <section class="blog-section section-padding fix">
        <div class="burger-shape">
            <img src="frontend/img/blog/burger-shape.png" alt="img">
        </div>
        <div class="pizza-shape">
            <img src="frontend/img/blog/pizza-shape.png" alt="img">
        </div>
        <div class="blog-wrapper style1">
            <div class="container">
                <div class="blog-card-wrap style1">
                    <div class="title-area">
                        <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                            <img class="me-1" src="frontend/img/icon/titleIcon.svg" alt="icon">LATEST NEWS<img
                                class="ms-1" src="frontend/img/icon/titleIcon.svg" alt="icon">
                        </div>
                        <h2 class="title wow fadeInUp" data-wow-delay="0.7s">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="blog-card style1 wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="blog-thumb">
                                            <img src="frontend/img/blog/blogThumb1_1.jpg" alt="thumb">
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-meta">
                                                ...
                                                <div class="item2">
                                                    <div class="icon"><img src="frontend/img/icon/user.svg"
                                                            alt="icon"><span>By Admin</span></div>
                                                </div>
                                                <div class="item3">
                                                    <div class="icon"><img src="frontend/img/icon/tag.svg"
                                ...
                                <div class="swiper-slide">
                                    <div class="blog-card style1 wow fadeInUp" data-wow-delay="0.4s">
                                        <div class="blog-thumb">
                                            <img src="frontend/img/blog/blogThumb1_2.jpg" alt="thumb">
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-meta">
                                                <div class="item1">
                                ...
                                <div class="swiper-slide">
                                    <div class="blog-card style1 wow fadeInUp" data-wow-delay="0.6s">
                                        <div class="blog-thumb">
                                            <img src="frontend/img/blog/blogThumb1_3.jpg" alt="thumb">
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-meta">
                                                <div class="item1">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gallery-thumb">
                                    <a href="menu.html">
                                        <img src="frontend/img/gallery/galleryThumb1_5.jpg" alt="thumb">
                                        <div class="icon"><img src="frontend/img/icon/camera.svg" alt="icon">
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-thumb">
                                    <a href="menu.html">
                                        <img src="frontend/img/gallery/galleryThumb1_1.jpg" alt="thumb">
                                        <div class="icon"><img src="frontend/img/icon/camera.svg" alt="icon">
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-thumb">
                                    <a href="menu.html">
                                        <img src="frontend/img/gallery/galleryThumb1_2.jpg" alt="thumb">
                                        <div class="icon"><img src="frontend/img/icon/camera.svg" alt="icon">
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-thumb">
                                    <a href="menu.html">
                                        <img src="frontend/img/gallery/galleryThumb1_3.jpg" alt="thumb">
                                        <div class="icon"><img src="frontend/img/icon/camera.svg" alt="icon">
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-thumb">
                                    <a href="menu.html">
                                        <img src="frontend/img/gallery/galleryThumb1_4.jpg" alt="thumb">
                                        <div class="icon"><img src="frontend/img/icon/camera.svg" alt="icon">
                                        </div>
                                    </a>
                                </div>
